...
public class SitterProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("My Account");
         ...
         StorageReference profileRef = storageReference.child("sitter/"+authProfile.getCurrentUser().getUid()+"profile.jpg");
        ...
        if(firebaseUser == null){
            Toast.makeText(SitterProfile.this, "Something went wrong! User's details are not available at the moment", Toast.LENGTH_LONG).show();
   ...
   /* Future<void> reload() async {
    ...
    private void showUserProfile(FirebaseUser firebaseUser) {
        ...
        referenceProfile.child(userID).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(SitterProfile.this, "Something went wrong", Toast.LENGTH_LONG).show();
    ...
    private void uploadImageToFirebase(Uri imageUri) {
        ...
        final StorageReference fileRef = storageReference.child("sitter/"+authProfile.getCurrentUser().getUid()+"profile.jpg");
        fileRef.putFile(imageUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(SitterProfile.this, "Failed", Toast.LENGTH_LONG).show();
            }
        });
